...
the limits m, n if these numbers exist otherwise `nil or null or None or Nothing (or ... depending on the language).
...
([193, 197] is also such a 4-gap primes between 130 and 200 but it's not the first pair)
    ...
    is not a 6-gap because there is 103 in between and 103-109is not a 6-gap because there is 107 in between.
