...
must train in the morning. He is curious how many stairs might be climbed over the next 20 years and has spent a year marking down his daily progress.
...
def stairs_in_20(stairs):
    totals = map(sum, stairs)
    return(sum(totals)*20)
